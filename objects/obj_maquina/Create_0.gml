...
// drops
meu_drop = [{drop : "gold", chance : 100, n_min : 400, n_max : 400}, {drop : "bones", chance : 100, n_min : 400, n_max : 400}]
...
atirando = function()
{
    ...
    else 
    {
        if (instance_exists(obj_player))
        {
            ...
            var _meu_tiro = instance_create_layer(x, y, "Tiro", obj_tiro_maquina)
