...
atirando = function()
{
    ...
    else 
    {
        if (instance_exists(obj_player))
        {
            ...
            var _meu_tiro = instance_create_layer(x, y, "Tiro", obj_tiro_inimigo_player)
            var _meu_tiro_2 = instance_create_layer(x, y, "Tiro", obj_tiro_inimigo_player)
            var _meu_tiro_3 = instance_create_layer(x, y, "Tiro", obj_tiro_inimigo_player)
            ...
            _meu_tiro.direction = _dir - 5
            _meu_tiro_2.direction = _dir
            _meu_tiro_3.direction = _dir + 5
