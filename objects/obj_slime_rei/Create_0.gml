...
atirando = function()
{
    ...
    else 
    {
        if (instance_exists(obj_player))
        {
            ...
            var _meu_tiro = instance_create_layer(x, y, "Tiro", obj_tiro_slime)
            var _meu_tiro_2 = instance_create_layer(x, y, "Tiro", obj_tiro_slime)
            var _meu_tiro_3 = instance_create_layer(x, y, "Tiro", obj_tiro_slime)
