if (!instance_exists(obj_anarquico_sombra) and !instance_exists(obj_maquina_sombra) and !instance_exists(obj_goblin_louco_sombra)) exit
...
var _txt = "Máquina Anárquica Insana das Sombras"
